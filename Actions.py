...
# General Driving
def drive_for_kickoff(self, my_car, car_to_desired_location, ball_location) -> str:
    ...
    if steer_correction_radians < math.radians(-5):
        # If the target is more than 10 degrees right from the centre, steer left
        turn = -1
        action_display = "turn left"
    elif steer_correction_radians > math.radians(5):
    ...
    print(car_location.dist(car_to_ball))
    if (car_location.dist(car_to_ball) < 1200):
        jump(self)
